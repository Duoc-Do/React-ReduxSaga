...
class SignUp extends Component {
    //create a class component because it related to form and we have to use state so we need to create a contructor by shorthand 'con'
    constructor(props) {
        super(props);
        this.state = {
            displayName: '',
        ...
        return (
            <div className='sign-up'>
                ...
                <form className='sign-up-form' onSubmit={this.handleSubmit}>
                    ...
                    <FormInput type='text' name='email' value={email} onChange={this.handelChange} label='Email' required />
